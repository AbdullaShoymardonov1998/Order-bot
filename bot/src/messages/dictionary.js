const WORD = {
  ...
  RU: {
    ...
    PREVIOUS: "👈🏻 предыдущая",
    CONFIRMED_VIDEO:
      "Отправленный вами видеофайл одобрен администратором и отправлен другим пользователям 🤩. \n\n Никогда не уставайте делиться новостями ⭐️",
    REJECTED_VIDEO:
      "Отправленный вами файл не был получен и был удален. Пожалуйста, попробуйте загрузить другое видео еще раз! \n",
    SEND_VACANCY: "Опубликовать вакансию",
    VACANCIES: "Вакансии",
    SEND_RESUME: "Отправить резюме",
    RESUMES: "Резюме",
    BIG_CLIENTS: "🟢 Цены для оптовых клиентов",
    SMALL_CLIENTS: "🔵 Цена для небольших клиентов",
    UNIT_PRICE: "🟣 Цена за штуку",
    COMMENT: "✍️ Оставить отзыв",
    VIEW_COMMENT: "🤩 Отзывы клиентов",
  },
  GENERAL: {
    HOME: "🏠 Bosh sahifa",
    ERROR:
